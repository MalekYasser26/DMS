...
import 'package:doctor_management_system/features/confirmation_view/presentation/views/add_note_confirm_view.dart';
import 'package:doctor_management_system/features/dates_view/presentation/views/widgets/absent_present_widget.dart';
import 'package:doctor_management_system/features/patient_details_view/presentation/views/patient_details_view.dart';
import 'package:doctor_management_system/features/confirmation_view/presentation/views/vacation_confirm_view.dart';
import 'package:doctor_management_system/features/results_view/presentation/views/results_view.dart';
import 'package:doctor_management_system/features/results_view/presentation/widgets/table_calendar_widget.dart';
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  SizedBox(
                                                    width :400.h,
                                                    height: 40.h,
                                                    child:  TableCalendarWidget(syncedDate:DateTime.now(),) ,
                                                  ),
                                                  SizedBox(height: 3.h,),
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                      ...
                                                      Expanded(
                                                        child: InkWell(
                                                          onTap: () => Navigator.push(context,
                                                              MaterialPageRoute(
                                                                builder: (context) => const VacationConfirmView(route: PatientListView())),
                                                          ),
                                                          child: Container(
                                                            height: 5.h,
                                                            decoration: const BoxDecoration(
                                        ...
                                        child: Directionality(
                                          ...
                                          child: PopupMenuButton<String>(
                                            ...
                                            onSelected: (String value) {
                                              if (value == 'item1') {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => const PatientDetailsView(initialIndex: 0),));
                                              } else if (value == 'item2') {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => const PatientDetailsView(initialIndex: 2),));
                                              } else if (value=='item3'){
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => NotesConfirmView(buttonroute1: (context) => const PatientListView(),buttonroute2: (context) => const PatientListView())));
                        },
                        child: Container(
                          height: 5.h,
                          decoration: const BoxDecoration(
