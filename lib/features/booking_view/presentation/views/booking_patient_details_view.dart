...
import 'package:doctor_management_system/features/booking_view/presentation/views/widgets/patient_details_widget.dart';
import 'package:doctor_management_system/features/confirmation_view/presentation/views/appointment_confirm_view.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5.h,),
                  BasicButtonRoute(
                      route: (context) => ConfirmView(buttonroute2: (context) => const MyDatesView(),buttonroute1: (context) => const AppointmentConfirmView(),),
                      color: AppColors.lightBlue,
