...
import 'package:doctor_management_system/features/booking_view/presentation/views/booking_patient_details_view.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                      ...
                      children: [
                        ...
                        RichText( text:TextSpan(
                            children: [
                              ...
                              TextSpan(
                                  recognizer: TapGestureRecognizer()..onTap = () => Navigator.push(context, MaterialPageRoute(builder: (context) => LoginView(route: (context) => const MyDatesView()),)) ,
                ...
                Row(
                  children: [
                    Expanded(child: BoxWidget(text: "كشف", height: 15.h, fontSize: 2.8.h, borderColor: AppColors.lightBlue, textColor: AppColors.lightBlue, route: (context) => const HomeView(),weight: FontWeight.bold,)),
                    SizedBox(width: 2.h,),
                    Expanded(child: BoxWidget(text: "استشارة", height: 15.h, fontSize: 2.8.h, borderColor: Colors.grey.shade600, textColor: Colors.black, route: (context) => const HomeView(),)),
                ...
                DropDownMenu(dropList: clinicName,iconDrop: Icons.location_on_outlined),
                SizedBox(height: 1.h,),
                Text("اختر التاريخ",style: GoogleFonts.cairo(fontWeight: FontWeight.w600,fontSize: 2.h,color: Colors.black)),
                DropDownMenu(dropList: dates,iconDrop: Icons.calendar_month),
                SizedBox(height: 1.h,),
                Text("اختر الوقت",style: GoogleFonts.cairo(fontWeight: FontWeight.w600,fontSize: 2.h,color: Colors.black)),
                DropDownMenu(dropList: timeStamps,iconDrop: Icons.watch_later_outlined,dir: TextDirection.ltr),
                const Spacer(),
                Padding(padding:  EdgeInsets.symmetric(vertical: 2.h),
                  child: BasicButtonRoute(route:(context) => const BookingPatientDetails(), color: AppColors.lightBlue, textColor: Colors.white, textSt: "التالي", borderColor: Colors.transparent),
                )
