...
import 'package:doctor_management_system/features/doctor_login_view/presentation/views/clinic_choice_view.dart';
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: Padding(
            ...
            child: ListView(
              children: [
                ...
                InkWell(
                  onLongPress: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const ClinicChoice(),),),
          ...
          children: [
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => const BookingIntroView(),));
              },
              child: Text("سجل الان",
                style:GoogleFonts.cairo(
                    fontSize: 14,
