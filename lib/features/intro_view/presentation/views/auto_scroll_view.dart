...
import 'package:doctor_management_system/features/intro_view/presentation/models/onboarding_model.dart';
  ...
  Widget build(BuildContext context) {
    return PageView.builder(
      ...
      onPageChanged: (index){
        ...
        if (index ==2 ){
          Future.delayed(const Duration(milliseconds: 1500),() => Navigator.push(context, MaterialPageRoute(builder: (context) => const HomeView() ))) ;
