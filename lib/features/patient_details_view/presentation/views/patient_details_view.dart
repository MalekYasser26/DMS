...
import 'package:doctor_management_system/features/patient_details_view/presentation/views/widgets/drug_alert._button_widget.dart';
import 'package:doctor_management_system/features/patient_details_view/presentation/views/widgets/note_alert_dialog_widget.dart';
import 'package:doctor_management_system/core/constants/assets.dart';
import 'package:doctor_management_system/features/patient_details_view/presentation/views/widgets/extra_notes_widget.dart';
import 'package:doctor_management_system/features/patient_details_view/presentation/views/widgets/medical_history_widget.dart';
import 'package:doctor_management_system/features/patient_details_view/presentation/views/widgets/drug_widget.dart';
import 'package:doctor_management_system/features/patient_details_view/presentation/views/widgets/medical_box_info_widget.dart';
                ...
                child: Column(
                  children: [
                    ...
                    Directionality(
                      ...
                      child: Row(
                        children: [
                          const MedicalBoxInfo(number: "22.4", category: "BMI",isBP: false,extraST: "10"),
                          SizedBox(width: 3.w,),
                          const MedicalBoxInfo(number: "92", category: "Weight",isBP: false,extraST: "10 kg"),
                          SizedBox(width: 3.w,),
                          const MedicalBoxInfo(number: "124/80", category: "Blood Pressure",isBP: true,extraST: ""),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TabBar(
                            ...
                            tabs:  [
                              ...
                              const Tab(text: "الأدوية",),
                              const Tab(text: "ملاحظات",),
                            ]),
                      ),
                    ),
                    Expanded(
