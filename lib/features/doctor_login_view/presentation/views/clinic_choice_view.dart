              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("اختر العيادة المراد رؤية المرضى بها",
                      style: GoogleFonts.cairo(
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Image.asset("assets/images/location.png",height:3.h,),
                    ),
                    Text("اختر المكان",
                      style: GoogleFonts.cairo(
                          fontWeight: FontWeight.w600,
                    ...
                    const Spacer(),
                    const Icon(Icons.keyboard_arrow_down,color: Color(0xffA3A3A3),)
                  ],
                ),
              ),
            ),
