...
import 'package:doctor_management_system/features/dates_view/presentation/views/widgets/appointment_widget.dart';
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              SizedBox(width: 20.w,),
                              InkWell(
                                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const BookingIntroView(),)),
                                child: Container(
