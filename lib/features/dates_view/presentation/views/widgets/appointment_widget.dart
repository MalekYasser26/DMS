...
class AppointmentWidget extends StatelessWidget {
  ...
  final bool isAbsent,isNext ;
   const AppointmentWidget({Key? key,required this.name,required this.date, required this.address , required this.firstTime,required this.isAbsent , required this.isNext}) : super(key: key);
          ...
          children: [
            Row(
              ...
              children: [
               ...
               isNext ==true ? AbsentPresentWidget(isAbsent: isAbsent,h: 4.h,w: 8.h,) : const Text("")
              ],
            ),
