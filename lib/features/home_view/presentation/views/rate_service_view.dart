...
import 'package:doctor_management_system/features/confirmation_view/presentation/views/confirm_rating_view.dart';
              ...
              child: Center(
                child: RatingBar(
                  ...
                  allowHalfRating: false,
                    minRating: 1,
                    maxRating: 5,
                    ratingWidget: RatingWidget(full: const Icon(Icons.star_rounded,color: AppColors.golden), half:const Icon(Icons.star_rounded,color: AppColors.golden) , empty: const Icon(Icons.star_outline_rounded,color: Colors.grey,)),
                ...
                Padding(
                  ...
                  child: BasicButtonRoute(route: (context) => const ConfirmRatingView(route: MyDatesView(),text: "تم التقييم بنجاح"),
